<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="126.28 146.364 82.111 100.211">
    ...
    <circle style="stroke: rgb(0, 0, 0); stroke-width: 7.37603px; fill: rgb(119, 208, 144); fill-opacity: 0.41;" cx="258.483" cy="212.276" r="61.489" transform="matrix(0.431929, 0, 0, 0.519574, 53.236794, 81.083017)"/>
  </svg>
</template>